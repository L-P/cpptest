...
COMPILE_FLAGS = -std=c++11 -Wall -Wextra -Werror -Weffc++ -pedantic -g \
	...
	-Wswitch-default -Wundef -Wzero-as-null-pointer-constant -Wuseless-cast

# Additional release-specific flags
RCOMPILE_FLAGS = -D NDEBUG -Os
# Additional debug-specific flags
DCOMPILE_FLAGS = -D DEBUG -O0
# Add additional include paths
INCLUDES = -I $(SRC_PATH)/
# General linker settings
LINK_FLAGS = -lgflags -lglog
